        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-header">Album :<?= esc($parrent['nama']); ?></div>
                    <div class="card-body">
                        <div class="row gx-3 mb-3">
                            <!-- Form Group (parrent) -->

                            <input type="hidden" name="parrent" value="<?= esc($parrent['id']); ?>">
                            ...
                            <input class="form-control" id="inputTipe" name="tipe" type="hidden" placeholder="Tipe" value="1">
