        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped compact" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php foreach ($clusters as $index => $rw) : ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <form action="<?= base_url('admin/wilayah/' . esc($rw['id'])); ?>" method="post" style="display:inline;">
        ...
        const table = $("#dataTable").DataTable({
            ...
            buttons: [{
                    ...
                    action: function(e, dt, node, config) {
                        window.location.href = '/admin/wilayah/add-rw/<?= $cluster['id'] ?>';
                    },
                },
                {
