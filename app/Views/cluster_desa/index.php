                    ...
                    <tbody>
                        <?php foreach ($clusters as $index => $cluster) : ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="<?= site_url('admin/wilayah/' . esc($cluster['id'])); ?>" class="btn btn-sm btn-secondary" title="Lihat Data">
        ...
        const table = $("#dataTable").DataTable({
            ...
            buttons: [{
                    ...
                    action: function(e, dt, node, config) {
                        window.location.href = '/admin/wilayah/new';
                    },
                },
                {
