                ...
                <div class="card-body">
                    ...
                    <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" id="inputNama" name="dusun" type="text" placeholder="Nama Wilayah" value="<?= old('pamong_nama', isset($pamong) ? esc($pamong['pamong_nama']) : ''); ?>" required>
                        </div>

                        <!-- Form Group (NIP) -->
                        <div class="col-md-6 mb-3">
                            <label class="small mb-1" for="id_kepala">NIK / Nama Kepala</label>
