...
<div class="container-fluid">
    ...
    <form action="<?= isset($analisisKlasifikasi) ? site_url('/admin/analisis-klasifikasi') : site_url('/admin/analisis-klasifikasi'); ?>" method="post">
        <?= csrf_field(); ?>
        <input type="hidden" name="id_master" value="<?= old('nama', isset($analisisKlasifikasi) ? $analisisKlasifikasi['id_master'] : ''); ?>">
        <?php if (isset($analisisKlasifikasi)) : ?>
            <input type="hidden" name="id" value="<?= esc($analisisKlasifikasi['id']); ?>">
        <?php endif; ?>
                        ...
                        <div class="row mb-3 justify-content-center">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="inputAnalisisKlasifikasiName" name="nama" type="text" placeholder="Nama Klasifikasi" value="<?= old('nama', isset($analisisKlasifikasi) ? $analisisKlasifikasi['nama'] : ''); ?>" required>
                                </div>
                            </div>
