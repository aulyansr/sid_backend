...
<table border=1 width="100%">
  ...
  <tr>
    <td colspan=2 valign="top" width="75%" height="20px" align="center"><b>DATA PEMOHON</b></td>
    ...
    <td  rowspan="4" align="center" valign="top" width="25%" ><img style="width: 3cm" src="<?= $base64; ?>" />
          ...
          <b><?php echo $master[0]['TGL_PEND'];?><br><br><br>
  ...
  <tr style="font-size: 11pt">
    ...
    <td valign="top" width="57%" style="border-left-color: #fff;"><b>:<?php echo $master[0]['NIK'];?></b><br>
          <b>:<?php echo $master[0]['NAMA_PEMOHON'];?></b> <br>
          <b>:<?php echo $master[0]['ALAMAT_PEMOHON'];?></b></td>
  </tr>
  <tr>
