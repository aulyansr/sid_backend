...
<body id="page-top">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Masukkan kata kunci.." aria-label="Search" aria-describedby="basic-addon2">
    ...
    <script>
        $(function() {
            $("#datepicker").datepicker({
                ...
                dateFormat: "dd-mm-yy" // Format tanggal sesuai keinginan
            });
        });
    </script>
    <script>
    ...
    <script>
        ...
        function previewFile(event, previewContainerId, fileNameId) {
            ...
            const fileName = inputFile.files[0]?.name || ''; // Ambil nama file
            const previewContainer = document.getElementById(previewContainerId);
            const fileNameElement = document.getElementById(fileNameId);

            if (fileName) {
                fileNameElement.textContent = fileName;
                previewContainer.style.display = 'block'; // Tampilkan kontainer preview
            } else {
        ...
        function removeFile(fileInputId, previewContainerId, fileNameId) {
