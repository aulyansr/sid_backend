<ul class="nav nav-tabs card-header-tabs" id="cardTab" role="tablist">
    <li class="nav-item">
        <a class="nav-link <?= ($activeTab == 'artikel') ? 'active' : '' ?>" id="card-artikel-tab" href="/admin/wilayah">Wilayah Administratif</a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link <?= ($activeTab == 'rtm') ? 'active' : '' ?>" id="card-komentar-tab" href="/admin/rtm">Rumah Tangga</a>
    </li>
    <li class="nav-item">
