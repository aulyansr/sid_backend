...
<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800 text-center"><?= isset($analisis) ? 'Edit Analisis Master' : 'Tambah Analisis Master'; ?></h1>
    <form action="<?= isset($analisis) ? site_url('/admin/analisis_master') : site_url('/admin/analisis_master'); ?>" method="post">
        <?= csrf_field(); ?>
                        ...
                        <div class="row gx-3 mb-3 justify-content-centers">
                                ...
                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                    <?php foreach ($lockOptions as $value => $label) : ?>
                                        <label class="btn btn-sm btn-outline-primary">
                                            <input type="radio" name="lock" value="<?= esc($value); ?>" id="lock_<?= esc($value); ?>" <?= (old('lock', isset($analisis) ? $analisis['lock'] : '') == $value) ? 'checked' : ''; ?>> <?= esc($label); ?>
                                        </label>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" id="inputpembagi" name="pembagi" type="text" value="<?= old('pembagi', isset($analisis) ? $analisis['pembagi'] : ''); ?>" required>
                                </div>
