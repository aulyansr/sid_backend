                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="uibutton-group">
                                        <a href="/admin/users/edit/<?= $user->id; ?>" class="btn btn-sm btn-warning" title="Ubah Data"><i class="fa fa-edit"></i> Ubah</a>
                                        <a href="/admin/users/delete/<?= $user->id; ?>" class="btn btn-sm btn-danger" title="Hapus Data"><i class="fa fa-trash"></i> Hapus</a>
                                        <a href="/admin/users/view/<?= $user->id; ?>" class="btn btn-sm btn-secondary" title="Lihat Data"><i class="fa fa-lock"></i></a>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <?php if (method_exists($user, 'getGroups')) : ?>
                                        ...
                                        <?php if (is_array($groups)) : ?>
                                            <?= implode(', ', $groups); // Convert array to comma-separated string 
                                            ?>
                                        <?php else : ?>
                                            <?= esc($groups); // If it's not an array, just escape the value 
                                            ?>
                                        <?php endif; ?>
                                    <?php else : ?>
                                        Tidak ada grup
