                    ...
                    <form action="<?= site_url('/admin/users/update'); ?>" method="post">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input class="form-control" id="inputFullName" name="full_name" type="text" placeholder="Nama Lengkap" value="<?= old('full_name', $user->full_name); ?>" required>
                            </div>
                            <!-- Form Group (username) -->
                            ...
                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                <?php foreach ($groups as $key => $group) : ?>
                                    <label class="btn btn-sm btn-outline-primary">
                                        <input type="radio" name="group" value="<?= esc($key); ?>" id="group_<?= esc($key); ?>" <?= old('group', $user->group) == $key ? 'checked' : ''; ?>> <?= esc($group['title']); ?>
                                    </label>
                                <?php endforeach; ?>
                            </div>
                        </div>
