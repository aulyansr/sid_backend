...
<div class="container-fluid">
    ...
    <form action="<?= isset($analisisPeriodeModel) ? site_url('/admin/analisis-periode') : site_url('/admin/analisis-periode/'); ?>" method="post">
        <?= csrf_field(); ?>
        <input type="hidden" name="id_master" value="<?= old('nama', isset($analisisPeriodeModel) ? $analisisPeriodeModel['id_master'] : ''); ?>">
        <?php if (isset($analisisPeriodeModel)) : ?>
            <input type="hidden" name="id" value="<?= esc($analisisPeriodeModel['id']); ?>">
        <?php endif; ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="nama" name="nama" type="text" placeholder="Nama Periode" value="<?= old('nama', isset($analisisPeriodeModel) ? $analisisPeriodeModel['nama'] : ''); ?>" required>
                            </div>
                        </div>
